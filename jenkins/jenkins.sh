...
echo -e "---\t A '$PROJECT_NAME' konyvtar elkeszult \t---\n"

sudo docker run -d --restart always --live-restore --name $PROJECT_NAME -v /docker/$PROJECT_NAME:/usr/src/app/temp -p 80:4200 noway0032/$PROJECT_NAME:latest $PARAM
